...
$res = $conn->query("Select * from mindray where name='DC-70m3'");
...
<form action="order.php" method='post'>
    <input  type="submit" class="btn btn-primary" name='DC-70m3' value='Place Order'>
...
$res = $conn->query("Select * from mindray where name='m3overviewp1'");
while($row=$res->fetch_assoc())
    {   
$cell1=$row['description'];
echo $cell1;
...
$res = $conn->query("Select * from mindray where name='m3overviewp2'");
while($row=$res->fetch_assoc())
    {   
$cell1=$row['description'];
echo $cell1;
...
$res = $conn->query("Select * from mindray where name='m3clinicalimage'");
while($row=$res->fetch_assoc())
        {   
$cell1=$row['image'];
echo $cell1;
...
$res = $conn->query("Select * from mindray where name='m3P7-3E'");
while($row=$res->fetch_assoc())
        {   
$cell1=$row['image'];
echo $cell1;
...
$res = $conn->query("Select * from mindray where name='m3P4-2E'");
while($row=$res->fetch_assoc())
        {   
$cell1=$row['image'];
echo $cell1;
...
?>" alt="">
                    ...
                    <div class="tab-pane fade" id="service-four">
                       <h4>DC-70 Quality Exams at Your Fingertips</h4>
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/YvWzExVIHKU" frameborder="0" allowfullscreen></iframe>  
                    </div>
                </div>
