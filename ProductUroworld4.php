...
<?php 
session_start(); 
    $_SESSION['sesname']='ProductUroworld4.php';
...
$res = $conn->query("Select * from info where name='Metal Dilator'");
...
echo $new_str;
    ...
    <input  type="submit" class="btn btn-primary" name='Metal-Dilator' value='Place Order'>
</form>
            </div>
        </div>
        <!-- /.row -->
...
$res = $conn->query("Select * from info where name='Screw Dilator'");
while($row=$res->fetch_assoc())
    {   
$cell1=$row['image'];
echo $cell1;
...
echo $new_str;
               ...
               <form action="order.php" method='post'>
    <input  type="submit" class="btn btn-primary" name='Screw-Dilator' value='Place Order'>
</form>
            </div>
        </div>
        <!-- /.row -->
...
$res = $conn->query("Select * from info where name='Ureteral Catheter'");
while($row=$res->fetch_assoc())
    {   
$cell1=$row['image'];
echo $cell1;
...
echo $cell1;
                ...
                <form action="order.php" method='post'>
    <input  type="submit" class="btn btn-primary" name='Ureteral-Catheter' value='Place Order'>
</form>
            </div>
        </div>
        <!-- /.row -->
...
echo $cell1;
              ...
              <form action="order.php" method='post'>
    <input  type="submit" class="btn btn-primary" name='Dual-Lumen-Catheter' value='Place Order'>
</form>
            </div>
        </div>
        <!-- /.row -->
...
$res = $conn->query("Select * from info where name='Biopsy Gun'");
while($row=$res->fetch_assoc())
    {   
$cell1=$row['image'];
echo $cell1;
...
echo $cell1;
              ...
              <form action="order.php" method='post'>
    <input  type="submit" class="btn btn-primary" name='Biopsy-Gun' value='Place Order'>
</form>
            </div>
        </div>
        <!-- /.row -->
...
$res = $conn->query("Select * from info where name='Cysto Catheter'");
while($row=$res->fetch_assoc())
    {   
$cell1=$row['image'];
echo $cell1;
...
echo $cell1;
               ...
               <form action="order.php" method='post'>
    <input  type="submit" class="btn btn-primary" name='Cysto-Catheter' value='Place Order'>
</form>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row text-center">
            <div class="col-lg-12">
                <ul class="pagination">
                    <li>
                        <a href="ProductUroworld3.php">&laquo;</a>
                    </li>
                    <li >
                    ...
                    <li>
                        <a href="ProductUroworld5.php">&raquo;</a>
                    </li>
                </ul>
            </div>
        </div>
