...
<body>
    <?php 
    session_start(); 
    $_SESSION['sesname']='ProductUroworld1.php';
...
<li>
        ...
        <div class="row">
            <div class="col-md-7">
                    ...
                    <img class="img-responsive img-hover" src="<?php $res = $conn->query("Select * from info where name='Bi-polar Loop'");
            ...
            <div class="col-md-5">
                ...
                <p>
                                ...
                                <form action="order.php" method='post'>
                                    <input  type="submit" class="btn btn-primary" name='Bi-polar-Loop' value='Place Order'>
                                </form>
            </div>
...
<form action="order.php" method='post'>
    <input  type="submit" class="btn btn-primary" name='Plasma-Button-Electrode' value='Place Order'>
</form>
...
<form action="order.php" method='post'>
    <input  type="submit" class="btn btn-primary" name='TURP-Loop-Electrode' value='Place Order'>
</form>
        </div>
        </div>
        <!-- /.row -->
...
echo $cell1;
                ...
                <form action="order.php" method='post'>
    <input  type="submit" class="btn btn-primary" name='Ureteral-Double-J-Stent' value='Place Order'>
</form>
            </div>
        </div>
        <!-- /.row -->
...
echo $cell1;
                 ...
                 <form action="order.php" method='post'>
    <input  type="submit" class="btn btn-primary" name='Urethral-Stent' value='Place Order'>
</form>
            </div>
        </div>
        <!-- /.row -->
...
echo $cell1;
                 ...
                 <form action="order.php" method='post'>
    <input  type="submit" class="btn btn-primary" name='Endopyelotomy-Stent' value='Place Order'>
</form>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row text-center">
            <div class="col-lg-12">
                <ul class="pagination">
                    ...
                    <li>
                        <a href="ProductUroworld2.php">&raquo;</a>
                    </li>
                </ul>
            </div>
        </div>
