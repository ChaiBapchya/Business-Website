...
$res = $conn->query("Select * from mindray where name='DC-8m2'");
...
<form action="order.php" method='post'>
    <input  type="submit" class="btn btn-primary" name='DC-8m2' value='Place Order'>
...
$res = $conn->query("Select * from mindray where name='m2overviewp1'");
while($row=$res->fetch_assoc())
    {   
$cell1=$row['description'];
echo $cell1;
...
$res = $conn->query("Select * from mindray where name='m2overviewp2'");
while($row=$res->fetch_assoc())
    {   
$cell1=$row['description'];
echo $cell1;
...
$res = $conn->query("Select * from mindray where name='clinicalimage'");
while($row=$res->fetch_assoc())
        {   
$cell1=$row['image'];
echo $cell1;
...
$res = $conn->query("Select * from mindray where name='P4-2E'");
while($row=$res->fetch_assoc())
        {   
$cell1=$row['image'];
echo $cell1;
...
$res = $conn->query("Select * from mindray where name='P7-3E'");
while($row=$res->fetch_assoc())
        {   
$cell1=$row['image'];
echo $cell1;
...
$res = $conn->query("Select * from mindray where name='P7-3TE'");
while($row=$res->fetch_assoc())
        {   
$cell1=$row['image'];
echo $cell1;
...
$res = $conn->query("Select * from mindray where name='P10-4E'");
while($row=$res->fetch_assoc())
        {   
$cell1=$row['image'];
echo $cell1;
...
$res = $conn->query("Select * from mindray where name='CW2s'");
while($row=$res->fetch_assoc())
        {   
$cell1=$row['image'];
echo $cell1;
...
<br>
                    ...
                    <div class="tab-pane fade" id="service-four">
                        <h4>MINDRAY DC-8</h4>
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/aO27mtDYdj4" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
