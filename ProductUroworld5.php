...
<?php 
session_start(); 
    $_SESSION['sesname']='ProductUroworld5.php';
...
$res = $conn->query("Select * from info where name='Initial Puncture Needle'");
...
echo $new_str;
    ...
    <input  type="submit" class="btn btn-primary" name='Initial-Puncture-Needle' value='Place Order'>
</form>
            </div>
        </div>
        <!-- /.row -->
...
$res = $conn->query("Select * from info where name='Filiform Urethral Dilator'");
while($row=$res->fetch_assoc())
    {   
$cell1=$row['image'];
echo $cell1;
...
echo $cell1;
               ...
               <form action="order.php" method='post'>
    <input  type="submit" class="btn btn-primary" name='Filiform-Urethral-Dilator' value='Place Order'>
</form>
            </div>
        </div>
        <!-- /.row -->
...
$res = $conn->query("Select * from info where name='PCN Drainage Set'");
while($row=$res->fetch_assoc())
    {   
$cell1=$row['image'];
echo $cell1;
...
echo $cell1;
                ...
                <form action="order.php" method='post'>
    <input  type="submit" class="btn btn-primary" name='PCN-Drainage-Set' value='Place Order'>
</form>
            </div>
        </div>
        <!-- /.row -->
...
$res = $conn->query("Select * from info where name='Ureteral Double J Stent Open Distal Tip'");
while($row=$res->fetch_assoc())
    {   
$cell1=$row['image'];
echo $cell1;
...
echo $cell1;
                ...
                <form action="order.php" method='post'>
    <input  type="submit" class="btn btn-primary" name='Ureteral-Double-J-Stent-Open-Distal-Tip' value='Place Order'>
</form>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row text-center">
            <div class="col-lg-12">
                <ul class="pagination">
                    <li>
                        <a href="ProductUroworld4.php">&laquo;</a>
                    </li>
                    <li >
